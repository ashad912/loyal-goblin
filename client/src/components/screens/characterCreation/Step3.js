...
const Step3 = (props) => {
  ...
  return (
    <React.Fragment >
      <img src={uiPaths[props.value]} style={{height: '22vh'}}/>
    ...
    <FormControl component="fieldset" style={{padding: '0 0.5rem', marginBottom: '20vh'}}>
      ...
      <img src={uiPaths[props.value+'Bg']} style={{width: '100%', position: 'absolute', bottom: -props.stepperHeight+'px', left: '0'}}/>
    </React.Fragment>
  );
};
